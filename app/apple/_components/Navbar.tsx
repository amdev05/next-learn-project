import { NAVGLOBALDATA } from "@/contents/apple";
  ...
  return (
    <nav className="">
      <div className="flex mx-auto w-fit">
        <ul className="flex flex-1 w-full gap-x-2.5">
          <li className="mr-auto lg:mr-0 size-12 px-4">
          ...
          <li className="">
            <div className="flex w-max text-xs justify-between gap-x-2.5">
              {NAVGLOBALDATA.map((nav, index) => (
                <Link href={`${nav.slug}`} key={index} className="flex items-center h-12 px-2">
                  <span className="text-nowrap">{nav.title}</span>
                </Link>
              ))}
            </div>
          </li>
        ...
        <div className="size-12 lg:hidden">
          <button className="size-12">
            <svg width="18" height="18" viewBox="0 0 18 18" className="mx-auto">
              <polyline id="globalnav-menutrigger-bread-bottom" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" points="2 12, 16 12">
                <animate
              ...
              <polyline id="globalnav-menutrigger-bread-top" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" points="2 5, 16 5">
                <animate
